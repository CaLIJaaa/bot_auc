...
CREATE TABLE IF NOT EXISTS `auction` (
	...
	description_en varchar(5000) NULL,
...
CREATE TABLE IF NOT EXISTS `bank` (
	...
	time_invoice TIMESTAMP NULL,
	CONSTRAINT bank_pk PRIMARY KEY (id),
	CONSTRAINT bank_user_FK FOREIGN KEY (user_id) REFERENCES `user`(tg_id) ON DELETE RESTRICT ON UPDATE CASCADE,
	CONSTRAINT bank_auction_FK FOREIGN KEY (auction_id) REFERENCES `auction`(id) ON DELETE RESTRICT ON UPDATE CASCADE
)
ENGINE=InnoDB
DEFAULT CHARSET=utf8mb4
COLLATE=utf8mb4_unicode_ci;
